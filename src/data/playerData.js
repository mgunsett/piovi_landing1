...
export const playerData = {
  ...
  gallery: [
    { id: 1, src: image1, alt: 'Gonzalo Piovi levantando un trofeo junto a sus compañeros de Cruz Azul', aspect: 'tall' },
    { id: 2, src: image2, alt: 'Gonzalo Piovi con su familia festejando un título de Cruz Azul en la cancha', aspect: 'wide' },
    { id: 3, src: image3, alt: 'Retrato de Gonzalo Piovi sonriendo con la medalla y el trofeo de campeón', aspect: 'square' },
    { id: 4, src: image4, alt: 'Gonzalo Piovi celebrando con el plantel de Cruz Azul entre confeti tras salir campeones', aspect: 'tall' },
    { id: 5, src: image5, alt: 'Gonzalo Piovi conduciendo el balón con la camiseta de Cruz Azul', aspect: 'tall' },
    { id: 6, src: image6, alt: 'Gonzalo Piovi entrenando con Cruz Azul antes de un partido', aspect: 'wide' },
    { id: 7, src: image7, alt: 'Gonzalo Piovi en acción con la camiseta titular de Cruz Azul', aspect: 'square' },
    { id: 8, src: image8, alt: 'Gonzalo Piovi posando con un trofeo de Cruz Azul', aspect: 'tall' },
    { id: 9, src: image9, alt: 'Gonzalo Piovi junto a su familia celebrando un título de Cruz Azul en el campo', aspect: 'tall' },
    { id: 10, src: image10, alt: 'Retrato de Gonzalo Piovi con la campera oficial de Cruz Azul', aspect: 'tall' },
    { id: 11, src: image11, alt: 'Gonzalo Piovi firmando camisetas a los hinchas de Cruz Azul', aspect: 'tall' },
    { id: 12, src: image12, alt: 'Gonzalo Piovi junto al plantel de Cruz Azul antes de un partido', aspect: 'tall' },
    { id: 13, src: image13, alt: 'Gonzalo Piovi en la presentación oficial de su renovación de contrato con Cruz Azul', aspect: 'tall' },
    { id: 14, src: image14, alt: 'Gonzalo Piovi aplaudiendo a la hinchada de Cruz Azul tras un partido', aspect: 'tall' },
    { id: 15, src: image15, alt: 'Gonzalo Piovi con la ropa oficial de Cruz Azul', aspect: 'tall' },
    { id: 16, src: image16, alt: 'Gonzalo Piovi entrenando con Cruz Azul', aspect: 'tall' },
    { id: 17, src: image17, alt: 'Gonzalo Piovi rematando el balón durante un partido con Cruz Azul', aspect: 'tall' },
    { id: 18, src: image18, alt: 'Gonzalo Piovi entrenando junto al plantel de Cruz Azul', aspect: 'tall' },
    { id: 19, src: image19, alt: 'Gonzalo Piovi conduciendo el balón con la camiseta suplente de Cruz Azul', aspect: 'tall' },
    { id: 20, src: image20, alt: 'Gonzalo Piovi celebrando un gol con la camiseta de Racing Club', aspect: 'tall' },
  ],
